import { SlashCommandBuilder, PermissionFlagsBits, AttachmentBuilder, ChatInputCommandInteraction } from 'discord.js'
...
export default {
    ...
    async execute(interaction: ChatInputCommandInteraction) {
        try {
            ...
            if(!log) throw new CommandInteractionError(Locales.get(interaction.locale, 'no_log_found'))

            const attachment = new AttachmentBuilder(log, { name: `${date}.log` })
