import { Guild, SlashCommandBuilder, PermissionFlagsBits, ChatInputCommandInteraction, TextChannel, userMention, time, TimestampStyles } from 'discord.js'
...
export default {
    ...
    async execute(interaction: ChatInputCommandInteraction) {
        try {
            ...
            if(guildMember && muteRole) await guildMember.roles.remove(muteRole)
