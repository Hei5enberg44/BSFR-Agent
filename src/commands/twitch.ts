...
export default {
    data: new SlashCommandBuilder()
        .setName('twitch')
        .setDescription(
            "Links your Twitch account to enable notifications when you're live"
        )
        .setDescriptionLocalization(
            'fr',
            "Lie votre compte Twitch afin d'activer les notifications lorsque vous êtes en live"
        )
    ...
    allowedChannels: [config.guild.channels['twitch-youtube']],
        ...
        try {
            ...
            switch (action) {
                case 'link': {
                    ...
                    if (channelName.match(/^https?:\/\//))
                        throw new CommandInteractionError(
                            Locales.get(
                                interaction.locale,
                                'twitch_channel_error'
                            )
                        )
                    ...
                    Logger.log(
                        'TwitchCommand',
                        'INFO',
                        `${interaction.user.username} a lié son compte Twitch`
                    )

                    await interaction.reply({
                        content: Locales.get(
                            interaction.locale,
                            'twitch_channel_linked'
                        ),
                        ephemeral: true
                    })
                    break
                ...
                case 'unlink': {
                    ...
                    Logger.log(
                        'TwitchCommand',
                        'INFO',
                        `${interaction.user.username} a délié son compte Twitch`
                    )

                    await interaction.reply({
                        content: Locales.get(
                            interaction.locale,
                            'twitch_channel_unlinked'
                        ),
                        ephemeral: true
                    })
                    break
